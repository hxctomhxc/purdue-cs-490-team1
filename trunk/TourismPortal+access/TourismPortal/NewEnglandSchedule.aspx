<%@ Page Title="New England Schedule" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="NewEnglandSchedule.aspx.cs" Inherits="About" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" 
                ...
                <tr height="20">
                    ...
                    <td class="style4" colspan="5" style="mso-ignore: colspan;" width="320">
                        Arrival in Maine and Group Dinner<span style="mso-spacerun: yes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                    <td class="style5" width="63">
                        Day 8</td>
                    <td class="style6" colspan="4" style="mso-ignore: colspan;" width="256">
                        Drive to Massachusetts and Group Dinner</td>
                ...
                <tr height="20">
                    ...
                    <td class="style19" colspan="3" style="mso-ignore: colspan">
                        New England cooking lessons</td>
                    <td class="style19">
                        &nbsp;</td>
                    <td class="style19">
                        &nbsp;</td>
                    ...
                    <td class="style20" colspan="4" style="mso-ignore: colspan">
                        Drive to Connecticut and Group Dinner</td>
                    <td class="style21">
                        &nbsp;</td>
                </tr>
                <tr height="20">
                    ...
                    <td class="style23" colspan="4" style="mso-ignore: colspan">
                        Drive to Vermont and Group Dinner</td>
                    <td class="style23">
                        &nbsp;</td>
                    <td class="style24">
                        Day 12</td>
